...
@ServerEndpoint("/ws/getsingle_ZB/{url}")
public class ChatAnnotation_ZB {
	private static final Set<ChatAnnotation_ZB> connections = new CopyOnWriteArraySet<ChatAnnotation_ZB>();
    ...
    */
    ...
    public static void broadcast(String msg, String num) {
		for (ChatAnnotation_ZB client : connections) {
			try {
				synchronized (client) {
